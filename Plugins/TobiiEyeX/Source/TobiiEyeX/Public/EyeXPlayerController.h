...
private:
	...
	AEyeXActorBase* FindByLineTrace(FHitResult& OutHit, const FSceneView* const View, const FVector2D& GazePoint, const FCollisionObjectQueryParams& TraceParams,
		const FCollisionQueryParams& ObjectParams);
	AEyeXActorBase* FindByBoxedLineTrace(FHitResult& OutHit, const FSceneView* const View, const FVector2D& GazePoint, const FCollisionObjectQueryParams& TraceParams,
		const FCollisionQueryParams& ObjectParams);
	...
	AEyeXActorBase* FindByFrustumIntersection(FHitResult& OutHit, const FSceneView* const View, const FVector2D& GazePoint, const FCollisionObjectQueryParams& TraceParams,
		const FCollisionQueryParams& ObjectParams);
